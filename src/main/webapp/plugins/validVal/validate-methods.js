...
$(function(){
    ...
    // 判断英文、数字字符 
    jQuery.validator.addMethod("isEngAndNo", function(value, element) {       
         return this.optional(element) || /^[\da-z]+$/i.test(value);       
    }, "只能包含英文、数字字符。"); 
    ...
    jQuery.validator.addMethod("isNotNull", function(value, element) { 
         return this.optional(element) || isNotNull(value)
    }, "不能为空"); 
