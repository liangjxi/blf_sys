 ...
 */
@Entity
@Table(name = "BLF_POSITION_ROLE", schema = "BLF_SYS", catalog = "")
public class BlfPositionRole {
    private int id;
    private String desc;
    ...
    private BlfRole blfRoleByRoleId;
    ...
    public boolean equals(Object o) {
        ...
        BlfPositionRole that = (BlfPositionRole) o;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (blfRoleByRoleId != null ? blfRoleByRoleId.hashCode() : 0);
        return result;
    }
    ...
    public BlfRole getBlfRoleByRoleId() {
        return blfRoleByRoleId;
    }

    public void setBlfRoleByRoleId(BlfRole blfRoleByRoleId) {
        this.blfRoleByRoleId = blfRoleByRoleId;
    }
}
