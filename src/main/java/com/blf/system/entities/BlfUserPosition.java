 ...
 */
@Entity
@Table(name = "BLF_USER_POSITION", schema = "BLF_SYS", catalog = "")
public class BlfUserPosition {
    private int id;
    private String desc;
    ...
    private BlfUser blfUserByUserId;
    ...
    public boolean equals(Object o) {
        ...
        BlfUserPosition that = (BlfUserPosition) o;
    ...
    public BlfUser getBlfUserByUserId() {
        return blfUserByUserId;
    }

    public void setBlfUserByUserId(BlfUser blfUserByUserId) {
        this.blfUserByUserId = blfUserByUserId;
    }
