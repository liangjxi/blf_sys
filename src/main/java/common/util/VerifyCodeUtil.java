...
public class VerifyCodeUtil {
    ...
    public static void main(String[] args) throws IOException {
        String verifyCode = generateTextCode(TYPE_ALL_MIXED, 4, null);
        System.out.println("verifyCode=" + verifyCode);
        BufferedImage bufferedImage = generateImageCode(verifyCode, 90, 30, 10, true, Color.WHITE, Color.BLACK, null);
        ImageIO.write(bufferedImage, "JPEG", new File("C:/Users/Tennyson/Desktop/code.jpg"));
    }
}
